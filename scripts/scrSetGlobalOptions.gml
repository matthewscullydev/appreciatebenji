...
global.roomCaptionDef = "Benji Benji Benji Benji Benji Benji Benji";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = roomStart;    //sets which room to begin with

global.menuMode = 1;            //sets whether to use a warp room or a menu for selecting the game's difficulty (0 = warp room, 1 = menu)
global.menuSound = sndCustom_MenuSelect;     //sets what sound to use for navigating the main menu
